...
class MartyyyKChatAPI:
    ...
    async def _wss(self):
        async with websockets.connect(
            ...
            logger.debug(f"MartyyyKChat connection debug info {init}")
            ...
            logger.debug("MartyyyKChat connected")
            self._show_warning = True
    ...
    async def _connect(self):
        while True:
            try:
                ...
                logger.debug("MartyyyKChat disconnection traceback", exc_info=True)
                ...
                if self._show_warning:
                    logger.debug("MartyyyKChat disconnected, retry in 5 sec")
