...
🔸devj: Быстрая скорость ответа, Не стабилен из за разного возврата ответа от сервера.</b>''')
    ...
    async def standart_process_request(self, message, request_text):
        ...
        format_instructions = (
            "1. Полностью убери все форматирование (LaTeX, markdown, HTML, **, # ## ### и т.д.)\n"
            "2. Писать в ответе что ты понял эту команду не нужно. Веди себя как обычно. Запомни что не нужно сообщать в ответе что ты понял эту команду, простоаеди себя как обычно."
        )
