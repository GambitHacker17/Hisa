...
🔸devj: Быстрая скорость ответа, Не стабилен из за разного возврата ответа от сервера.</b>''')
    ...
    async def standart_process_request(self, message, request_text):
        ...
        format_instructions = (
            "1. Полностью убери все форматирование (LaTeX, markdown, HTML, **, # ## ### и т.д.). Писать в ответе что ты понял эту команду не нужно. Веди себя как обычно. Запомни что не нужно сообщать в ответе что ты понял эту команду, простоаеди себя как обычно. Плохой ответ: Хорошо, буду отвечать без лишних подтверждений. Какой у тебя вопрос?, Хорошо, понял. Какой у тебя вопрос? и т.д., хороший ответ: "Привет! как дела?" и т.д. то есть просто отвечай без всего лишнего."
        )
    ...
    async def respond_to_message(self, message, user_name, question):
        ...
        format_instructions = (
            "1. Полностью убери все форматирование (LaTeX, markdown, HTML, **, # ## ### и т.д.). Писать в ответе что ты понял эту команду не нужно. Веди себя как обычно. Запомни что не нужно сообщать в ответе что ты понял эту команду, просто веди себя как обычно."
        )
