...
class CdnMethodInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('This method cannot be invoked on a CDN server. Refer to https://core.telegram.org/cdn
    def __reduce__(self):
        return type(self), (self.request,)
...
class ChatGuestSendForbiddenError(ForbiddenError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('You join the discussion group before commenting, see [here](/api/discussion
    def __reduce__(self):
        return type(self), (self.request,)
...
class ChatTooBigError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('This method is not available for groups with more than `chat_read_mark_size_threshold` members, [see client configuration](https://core.telegram.org/api/config
    def __reduce__(self):
        return type(self), (self.request,)
...
class LimitInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('An invalid limit was provided. See https://core.telegram.org/api/files
    def __reduce__(self):
        return type(self), (self.request,)
...
class LocationInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('The location given for a file was invalid. See https://core.telegram.org/api/files
    def __reduce__(self):
        return type(self), (self.request,)
...
class MsgTooOldError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('[`chat_read_mark_expire_period` seconds](https://core.telegram.org/api/config
    def __reduce__(self):
        return type(self), (self.request,)
...
class OffsetInvalidError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('The given offset was invalid, it must be divisible by 1KB. See https://core.telegram.org/api/files
    def __reduce__(self):
        return type(self), (self.request,)
...
class ReactionsTooManyError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__("The message already has exactly `reactions_uniq_max` reaction emojis, you can't react with a new emoji, see [the docs for more info](/api/config
    def __reduce__(self):
        return type(self), (self.request,)
...
class ResultsTooMuchError(BadRequestError):
    def __init__(self, request):
        self.request = request
        super(Exception, self).__init__('You sent too many results, see https://core.telegram.org/bots/api
    def __reduce__(self):
        return type(self), (self.request,)
