...
from hisatl .tl .functions .account import UpdateNotifySettingsRequest 
...
HisaReplyMarkup =typing .Union [typing .List [typing .List [dict ]],typing .List [dict ],dict ]
...
class Module :
    ...
    @property 
    def hisa_commands (self )->typing .Dict [str ,Command ]:
        """List of commands that module supports"""
        return get_commands (self )
    ...
    @property 
    def hisa_inline_handlers (self )->typing .Dict [str ,Command ]:
        """List of inline handlers that module supports"""
        return get_inline_handlers (self )
    ...
    @property 
    def hisa_callback_handlers (self )->typing .Dict [str ,Command ]:
        """List of callback handlers that module supports"""
        return get_callback_handlers (self )
    ...
    @property 
    def hisa_watchers (self )->typing .Dict [str ,Command ]:
        """List of watchers that module supports"""
        return get_watchers (self )
    ...
    @hisa_commands .setter 
    def hisa_commands (self ,_ ):
        pass 
    ...
    @hisa_inline_handlers .setter 
    def hisa_inline_handlers (self ,_ ):
        pass 
    ...
    @hisa_callback_handlers .setter 
    def hisa_callback_handlers (self ,_ ):
        pass 
    ...
    @hisa_watchers .setter 
    def hisa_watchers (self ,_ ):
        pass 
    ...
    *,
    inline :bool =False ,
        ...
        with contextlib .suppress (AttributeError ):
            _hisa_client_id_logging_tag =copy .copy (self .client .tg_id )
    ...
    event :asyncio .Event ,
        ...
        "hisa.main",
        "declined_joins",
        list (set (self ._db .get ("hisa.main","declined_joins",[])+[channel .id ])),
        )
        event .status =False 
        event .set ()
        await call .edit (
    ...
    assure_joined :typing .Optional [bool ]=False ,
        ...
        if channel .id in self ._db .get ("hisa.main","declined_joins",[]):
            if assure_joined :
                raise LoadError (
        ...
        self .hisa_wait_channel_approve =(
        self .__class__ .__name__ ,
        channel ,
        reason ,
        )
        ...
        with contextlib .suppress (AttributeError ):
            delattr (self ,"hisa_wait_channel_approve")
    ...
    *,
    ...
    _did_requirements :bool =False ,
        ...
        if re .search (r"# ?scope: ?hisa_min",code ):
            ver =tuple (
            map (
            int ,
            re .search (r"# ?scope: ?hisa_min ((\d+\.){2}\d+)",code )[1 ].split (
            "."
            ),
            )
            )
            ...
            if version .__version__ <ver :
                _raise (
                RuntimeError (
                f"Library requires Hisa version {'{}.{}.{}'.format (*ver )}+"
                )
                )

        module =f"hisa.libraries.{url .replace ('%','%%').replace ('.','%d')}"
        ...
        and self ._db .get ("hisa.main","stats",True )
        and url is not None 
...
class DragonModule :
    ...
    def __init__ (self ):
        ...
        self .hisa_inline_handlers ={}
        self .callback_handlers ={}
        self .hisa_callback_handlers ={}
