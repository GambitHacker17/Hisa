...
import hisatl
from hisapyro import Client as PyroClient
from hisapyro import errors as pyro_errors
...
PROXY = {
    pyro_object: hisatl.tl.alltlobjects.tlobjects[constructor_id]
    for constructor_id, pyro_object in raw.all.objects.items()
    if constructor_id in hisatl.tl.alltlobjects.tlobjects
}
...
REVERSED_PROXY = {
    ...
    **{
        ...
        for _, tl_object in utils.iter_attrs(hisatl.tl.custom)
...
class PyroProxyClient(PyroClient):
    ...
    def __init__(self, tl_client: CustomTelegramClient):
        ...
        super().__init__(
            ...
            lang_code="en",
            in_memory=True,
            phone_number=tl_client.hisa_me.phone,
        )
    ...
    def _on_event(
        self,
        event: typing.Union[
            hisatl.tl.types.Updates,
            hisatl.tl.types.UpdatesCombined,
            hisatl.tl.types.UpdateShort,
        ],
    ):
    ...
    async def invoke(
        ...
        **kwargs,
        ...
        except hisatl.errors.rpcerrorlist.RPCError as e:
    ...
    @staticmethod
    def _tl_error2pyro(
        error: hisatl.errors.rpcerrorlist.RPCError,
    ...
    def _pyro2tl(self, pyro_obj: raw.core.TLObject) -> hisatl.tl.TLObject:
        """
    ...
    def _tl2pyro(self, tl_obj: hisatl.tl.TLObject) -> raw.core.TLObject:
        """
        ...
        if (
            ...
            tl_obj.from_id = hisatl.tl.types.PeerUser(tl_obj.sender_id)
        ...
        if not isinstance(tl_obj, hisatl.tl.TLObject):
            return tl_obj
    ...
    async def resolve_peer(
        ...
        *args,
        **kwargs,
    ) -> "typing.Union[hisapyro.raw.types.PeerChat, hisapyro.raw.types.PeerChannel, hisapyro.raw.types.PeerUser]":  # type: ignore  # noqa: E501, F821
        """
        ...
        :rtype: typing.Union[hisapyro.raw.types.PeerChat, hisapyro.raw.types.PeerChannel, hisapyro.raw.types.PeerUser]
        """
