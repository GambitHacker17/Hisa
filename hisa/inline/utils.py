...
from hisatl.utils import resolve_inline_message_id
...
class Utils(InlineUnit):
    def _generate_markup(
        self,
        markup_obj: typing.Optional[typing.Union[HisaReplyMarkup, str]],
    ...
    def _normalize_markup(
        self, reply_markup: HisaReplyMarkup
    ...
    def _validate_markup(
        self,
        buttons: typing.Optional[HisaReplyMarkup],
    ) -> typing.List[typing.List[typing.Dict[str, typing.Any]]]:
        if buttons is None:
            buttons = []
