...
from hisatl.errors.rpcerrorlist import ChatSendInlineForbiddenError
from hisatl.extensions.html import CUSTOM_EMOJIS
from hisatl.tl.types import Message

from .. import main, utils
from ..types import HisaReplyMarkup
...
class List(InlineUnit):
    async def list(
        ...
        *,
        ...
        silent: bool = False,
        custom_buttons: typing.Optional[HisaReplyMarkup] = None,
        ...
        :param manual_security: By default, Hisa will try to inherit inline buttons security from the caller (command)
                                If you want to avoid this, pass `manual_security=True`
        :param disable_security: By default, Hisa will try to inherit inline buttons security from the caller (command)
        ...
        with contextlib.suppress(AttributeError):
            _hisa_client_id_logging_tag = copy.copy(self._client.tg_id)  # noqa: F841
            ...
            try:
                status_message = await (
                    ...
                    (
                        ...
                        if self._client.hisa_me.premium and CUSTOM_EMOJIS
                        else "🌘"
                    )
    ...
    def _list_markup(self, unit_id: str) -> InlineKeyboardMarkup:
        ...
        return self.generate_markup(
            ...
            + [[{"text": "🔻 Close", "callback": self._close_menu}]],
        )

    async def _close_menu(self, call: CallbackQuery):
