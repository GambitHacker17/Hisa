...
from hisatl.errors.rpcerrorlist import InputUserDeactivatedError, YouBlockedUserError
...
class InlineManager(
    ...
    :type client: hisa.tl_cache.CustomTelegramClient
    :type db: hisa.database.Database
    :type allmodules: hisa.loader.Modules
    """
    ...
    def __init__(
        ...
        self._token = db.get("hisa.inline", "bot_token", False)
    ...
    async def register_manager(
        ...
        self._name = get_display_name(self._client.hisa_me)
        ...
        try:
            m = await self._client.send_message(self.bot_username, "/start hisa init")
            ...
            try:
                m = await self._client.send_message(
                    self.bot_username, "/start hisa init"
                )
            except Exception:
