...
@loader.tds
class HisaConfigMod(loader.Module):
    """Interactive configurator for Hisa Userbot"""

    strings = {"name": "HisaConfig"}
    ...
    async def _close_btn(self, call: InlineCall):
        await call.edit(self.strings("config_closed"), reply_markup=None)
        ...
        await call.edit(
            ...
            reply_markup=[
                [
                    ...
                    {"text": self.strings("close_btn"), "callback": self._close_btn},
                ]
            ],
