...
class MessageEditor:
    def __init__(
        self,
        message: hisatl.tl.types.Message,
        command: str,
        config,
        strings,
        request_message,
    ...
    async def redraw(self):
        ...
        with contextlib.suppress(hisatl.errors.rpcerrorlist.MessageNotModifiedError):
            ...
            except hisatl.errors.rpcerrorlist.MessageTooLongError as e:
                logger.error(e)
                logger.error(text)
...
class SudoMessageEditor(MessageEditor):
    ...
    async def update_stderr(self, stderr):
        ...
        if lastlines[0] == self.PASS_REQ and self.state == 0:
            ...
            except hisatl.errors.rpcerrorlist.MessageNotModifiedError as e:
                logger.debug(e)
            ...
            self.message[0].client.add_event_handler(
                ...
                hisatl.events.messageedited.MessageEdited(chats=["me"]),
            )
    ...
    async def on_message_edited(self, message):
        ...
        if hash_msg(message) == hash_msg(self.authmsg):
            ...
            except hisatl.errors.rpcerrorlist.MessageNotModifiedError:
...
class RawMessageEditor(SudoMessageEditor):
    ...
    async def redraw(self):
        ...
        with contextlib.suppress(
            hisatl.errors.rpcerrorlist.MessageNotModifiedError,
            hisatl.errors.rpcerrorlist.MessageEmptyError,
            ValueError,
        ):
            try:
                await utils.answer(self.message, text)
