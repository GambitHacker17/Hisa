...
@loader.tds
class HisaInfoMod(loader.Module):
    strings = {"name": "HisaInfo"}
    def __init__(self):
    ...
    def _render_info(self, inline: bool) -> str:
        ...
        return (
            (
                "<b>🌘 Hisa</b>\n"
                if "hisa" not in self.config["custom_message"].lower()
                else ""
            )
                ...
                *map(
                    ...
                    (
                        (
                            ...
                            if self._client.hisa_me.premium and not inline
                            else "🌘 Hisa"
                        ),
    ...
    async def info(self, _: InlineQuery) -> dict:
        return {
            ...
            **(
            ...
            "thumb": (
                "https://raw.githubusercontent.com/GambitHacker17/Hisa/Master/hisa_pfp.png"
            ),
    ...
    @loader.command()
    async def hisainfo(self, message: Message):
