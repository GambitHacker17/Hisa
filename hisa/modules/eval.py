...
import hisatl
from hisatl.errors.rpcerrorlist import MessageIdInvalidError
from hisatl.sessions import StringSession
from hisatl.tl.types import Message
from meval import meval

from .. import loader, main, utils
from ..log import HisaException
...
class Evaluator(loader.Module):
    ...
    async def e(self, message: Message):
        try:
            ...
            item = HisaException.from_exc_info(*sys.exc_info())
    ...
    def censor(self, ret: str) -> str:
        ret = ret.replace(str(self._client.hisa_me.phone), "&lt;phone&gt;")
        ...
        if btoken := self._db.get("hisa.inline", "bot_token", False):
            ret = ret.replace(
                btoken,
                f'{btoken.split(":")[0]}:{"*" * 26}',
            )
    ...
    async def getattrs(self, message: Message) -> dict:
        ...
        return {
            ...
            "reply": reply,
            "r": reply,
            **self.get_sub(hisatl.tl.types),
            **self.get_sub(hisatl.tl.functions),
            "event": message,
            "chat": message.to_id,
            "hisatl": hisatl,
            "telethon": hisatl,
                ...
                itertools.chain.from_iterable(
                    [
                        ...
                        for y in filter(
                            ...
                            and x[1] != obj
                            and x[1].__package__.rsplit(".", _depth)[0] == "hisatl.tl",
                            obj.__dict__.items(),
                        )
                    ]
                )
