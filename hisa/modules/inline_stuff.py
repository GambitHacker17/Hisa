...
class InlineStuff(loader.Module):
    ...
    @loader.command()
    async def ch_hisa_bot(self, message: Message):
        ...
        self._db.set("hisa.inline", "custom_bot", args)
    ...
    async def ch_bot_token(self, message: Message):
        ...
        if not args or not re.match(r'[0-9]{8,10}:[a-zA-Z0-9_-]{34,36}', args):
            ...
            return
        self._db.set("hisa.inline", "bot_token", args)
        await utils.answer(message, self.strings("bot_updated"))
    ...
    async def aiogram_watcher(self, message: BotInlineMessage):
        ...
        if message.text == "/start":
            await message.answer_photo(
                "https://raw.githubusercontent.com/GambitHacker17/Hisa/Master/Start_cmd.png",
                caption=self.strings("this_is_hisa"),
            )