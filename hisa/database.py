...
from hisatl.errors.rpcerrorlist import ChannelsTooMuchError
from hisatl.tl.types import Message, User
    ...
    async def init(self):
        ...
        try:
            self._assets, _ = await utils.asset_channel(
                self._client,
                "hisa-assets",
                "🌆 Your hisa assets will be stored here",
                archive=True,
                avatar="https://raw.githubusercontent.com/GambitHacker17/Hisa/Master/Hisa-assets.png",
            )
