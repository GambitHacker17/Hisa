...
class VoicyMod(loader.Module):
    ...
    strings = {
        ...
        "too_big": "🫥 <b>Voice message is too big, can't recognise it...</b>",
    }
    ...
    strings_ru = {
        ...
        "_cmd_doc_autovoice": (
            "- вкл/выкл автораспознавание в чате"
        ),
        "_cls_doc": "Распознает голосовые/видео сообщения, аудио и видео",
        ...
        "too_big": (
            "🫥 <b>Голосовое сообщение слишком большое, не удалось его распознать...</b>"
        ),
    }
